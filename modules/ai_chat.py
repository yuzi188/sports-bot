"""
AI 客服聊天模組 V15 - USDT/香港站 FAQ 更新版
新增：
  1. USDT/香港站 FAQ：引導用戶至香港站儲值 U
  2. 統一引導語格式：如需進一步協助，請聯繫 VIP 客服專員：@yu_888yu 😊
"""
...
# 統一引導語
_CS_GUIDE = "如需進一步協助，請聯繫 VIP 客服專員：@yu_888yu 😊"
...
def get_ai_response(user_id: int, user_message: str) -> str:
    ...
    try:
        ...
        if "@yu_888yu" not in ai_reply and any(kw in user_message for kw in ["客服", "聯繫", "找人", "問題", "幫我", "怎麼", "為什麼", "帳號", "金流", "儲值", "提現"]):
             # 只有在用戶問問題或提到客服相關時才主動附加，避免閒聊也附加
             if not ai_reply.endswith(_CS_GUIDE):
                 ai_reply += f"\n\n{_CS_GUIDE}"
