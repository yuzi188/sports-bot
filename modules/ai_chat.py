...
- 不確定的事情絕對不亂說，引導聯繫官方 LINE 客服：@ofa88
...
超出範圍：
  「老闆您好，關於您諮詢的問題已經超出了客服的服務範圍，非常抱歉不能為您解答，請您聯繫官方LINE客服：@ofa88」
...
_FAQ_DB = [
    ...
    (
        ...
        "老闆您好，會員帳號為您的手機號哦，還請您提供，以便客服為您協助。\n\n"
        "如需進一步協助，請聯繫官方 LINE 客服：@ofa88 🙏",
    ),
    (
        ["一個帳號", "多個帳號", "兩個帳號", "重複帳號", "開新帳號"],
        "老闆您好，我方一位會員只可以使用一組帳號進行遊玩，還請您留意。\n\n"
        "如有其他問題，歡迎聯繫官方 LINE 客服：@ofa88 🙏",
    ),
    # ── 託售點數 ──
    (
        ["託售", "託售點數", "賣點數", "點數託售"],
    ...
    (
        ["驗證", "實名認證", "身份驗證", "KYC", "認證"],
        "老闆您好，關於帳號驗證問題，請聯繫官方 LINE 客服由專人為您協助：@ofa88 🙏",
    ),
    # ── 密碼問題 ──
    (
        ["密碼", "忘記密碼", "重設密碼", "修改密碼", "密碼錯誤"],
        "老闆您好，關於密碼問題，請聯繫官方 LINE 客服由專人為您協助重設：@ofa88 🙏",
    ),
    # ── 客服聯繫 ──
    (
        ["客服", "聯繫客服", "找客服", "人工客服", "line客服", "LINE客服"],
        "老闆您好，官方 LINE 客服：@ofa88\n\n"
...
_OUT_OF_SCOPE_REPLY = (
    ...
    "非常抱歉不能為您解答，請您聯繫官方 LINE 客服：@ofa88 🙏"
)
